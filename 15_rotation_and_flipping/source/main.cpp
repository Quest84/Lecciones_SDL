...
bool init() {
    ...
    if( SDL_Init( SDL_INIT_VIDEO ) < 0 ) {
        ...
        // Crea la ventana
        gWindow = SDL_CreateWindow( "SDL Tutorial 15 - Rotation and Flipping", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED,
...
bool loadMedia() {
    ...
    if( !gArrowTexture.loadFromFile( "romfs/Akita_Jump_3.png" ) ) {
