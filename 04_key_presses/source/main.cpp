...
bool loadMedia() {
	...
	gKeyPressSurfaces[ KEY_PRESS_SURFACE_DEFAULT ] = loadSurface( "romfs/press.bmp" );
	...
	gKeyPressSurfaces[ KEY_PRESS_SURFACE_UP ] = loadSurface( "romfs/up.bmp" );
	...
	gKeyPressSurfaces[ KEY_PRESS_SURFACE_DOWN ] = loadSurface( "romfs/down.bmp" );
	...
	gKeyPressSurfaces[ KEY_PRESS_SURFACE_LEFT ] = loadSurface( "romfs/left.bmp" );
	...
	gKeyPressSurfaces[ KEY_PRESS_SURFACE_RIGHT ] = loadSurface( "romfs/right.bmp" );
